...
COMMON_TRAIN_FORMAT = [('step', 'S', 'int'),('fps', 'FPS', 'float'), ('total_time', 'T', 'time'),
...
class MetersGroup:
    def __init__(self, csv_file_name: tp.Union[Path, str], formating: Formating) -> None:
...
class Logger:
    def __init__(self, log_dir: Path, use_tb: bool) -> None:
