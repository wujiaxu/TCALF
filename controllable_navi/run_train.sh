...
declare -a sessions_and_scripts=(
    ...
    "gd_aps_3_wo_sf_5_alpha_001:pretrain.py device=cuda:0 agent=gd_aps agent.sf_dim=5 agent.balancing_factor=0.01 task=crowdnavi_PointGoalNavi use_tb=1 use_hiplog=1 replay_buffer_episodes=2000 discount=0.99 obs_type=raw_scan agent.lr=0.000001 agent.critic_target_tau=0.001 reward_free=True num_seed_frames=2000 save_video=True crowd_sim=CrowdWorld crowd_sim.max_human_num=3 crowd_sim.with_static_obstacle=False crowd_sim.map_size=6 crowd_sim.reward_goal=0.25 crowd_sim.goal_factor=0.2 crowd_sim.penalty_collision=-0.25"
    "gd_aps_3_wo_sf_5_alpha_0001:pretrain.py device=cuda:1 agent=gd_aps agent.sf_dim=5 agent.balancing_factor=0.001 task=crowdnavi_PointGoalNavi use_tb=1 use_hiplog=1 replay_buffer_episodes=2000 discount=0.99 obs_type=raw_scan agent.lr=0.000001 agent.critic_target_tau=0.001 reward_free=True num_seed_frames=2000 save_video=True crowd_sim=CrowdWorld crowd_sim.max_human_num=3 crowd_sim.with_static_obstacle=False crowd_sim.map_size=6 crowd_sim.reward_goal=0.25 crowd_sim.goal_factor=0.2 crowd_sim.penalty_collision=-0.25"
    "gd_aps_3_wo_sf_5_alpha_00001:pretrain.py device=cuda:2 agent=gd_aps agent.sf_dim=5 agent.balancing_factor=0.0001 task=crowdnavi_PointGoalNavi use_tb=1 use_hiplog=1 replay_buffer_episodes=2000 discount=0.99 obs_type=raw_scan agent.lr=0.000001 agent.critic_target_tau=0.001 reward_free=True num_seed_frames=2000 save_video=True crowd_sim=CrowdWorld crowd_sim.max_human_num=3 crowd_sim.with_static_obstacle=False crowd_sim.map_size=6 crowd_sim.reward_goal=0.25 crowd_sim.goal_factor=0.2 crowd_sim.penalty_collision=-0.25"
